---
title: "Data Preperation File for t2 CAM study (samples from USA, Germany)  - first step create data sets"
author: "Julius Fenn"
format:
  html:
    toc: true
...
if(all(colnames(questionnaire_CAM_Germany) == colnames(questionnaire_CAM_USA))){
  ...
  saveRDS(object = questionnaireCAMs, file = "questionnaireCAMs.rds")
}
```
