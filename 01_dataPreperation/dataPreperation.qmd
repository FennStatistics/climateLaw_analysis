...
```{r}
#| label: dependency filters to not finished
#| echo: true
#| warning: false
...
```
0) remove participants who not have finished the study (internal variable by Qualtrics):


```{r}
#| label: remove who not finished study
#| echo: true
#| warning: false
